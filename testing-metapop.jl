...
# ╔═╡ fd0ed602-32e8-11ef-3a9e-33f6202a93c5
begin
	using MetapopulationDynamics
	using Plots
end

# ╔═╡ 3e37ec47-9fb1-4129-bb30-449828a45701
sl = StochasticLogistic(dt = 0.01, σ = 1.0)

# ╔═╡ 7584f4ae-394e-41ab-9e8b-5ad59b5d3c4c
rm = RickerModel()

# ╔═╡ afdf2d28-6f02-4c06-9cc5-6627a08fdf0e
sg = SpatialGraph()

# ╔═╡ f7d7e6e6-1ea4-4fe7-81bb-66d8ba1c5cd6
djdm = DeterministicJumpDispersalModel(
	0.8,
	DispersalPotential(ExponentialDispersalKernel(decay = 10.0, threshold = 0.01), sg),
)

# ╔═╡ 4ac012be-d1d6-45ec-a738-c3db3395db8f
sjdm = StochasticJumpDispersalModel(
	0.1,
	DispersalPotential(ExponentialDispersalKernel(decay = 1, threshold = 0.01), sg ),
)

# ╔═╡ d9d5853c-7e60-4ec7-bdec-1796d3bf2f15
fullmodel = modelset(djdm, rm)

# ╔═╡ 1331169f-0335-4f52-a3ae-02ab2bcae349
results = simulate(fullmodel, sg; numtimesteps = 100)

# ╔═╡ 52782bdc-e50d-42ef-a36e-3da8663e87dd
plt = plot(legend = :outerright, xlabel = "time", ylabel = "Abundance")

# ╔═╡ 5727e584-c021-4a74-9a47-0fc14fe072f5
for i = 1:size(results.timeseries, 1)
	plot!(1:size(results.timeseries, 2), results.timeseries[i, :], label = "Pop $i")
end

# ╔═╡ 66eb7b37-a9c7-4f48-b658-ca8ae5ad27f2
distancematrix(sg)

# ╔═╡ 2087a28d-e27e-4270-ba52-626dfd7bd5aa
new_sg = SpatialGraph(2)

# ╔═╡ b5ecae09-fc7d-4f78-aaf0-3b762d5631b4
distancematrix(new_sg)

# ╔═╡ 00000000-0000-0000-0000-000000000001
PLUTO_PROJECT_TOML_CONTENTS = """
[deps]
MetapopulationDynamics = "67afee28-ec33-4cc2-88ea-a48c87ed52f9"
Plots = "91a5bcdd-55d7-5caf-9e0b-520d859cae80"

[compat]
MetapopulationDynamics = "~0.0.1"
Plots = "~1.40.4"
"""
...
manifest_format = "2.0"
project_hash = "693e3d803a7a1b2229027eb7b3883845dcfeba3a"

[[deps.ASCIIrasters]]
git-tree-sha1 = "1880b17ca0e1c0edd3fa8a968fca20516af7436a"
...
[[deps.AbstractNumbers]]
deps = ["SpecialFunctions"]
git-tree-sha1 = "c0aa4b519104fecca9bc146c9843393f7cbd3c99"
...
[[deps.DynamicGrids]]
deps = ["Adapt", "Colors", "ConstructionBase", "Crayons", "Dates", "DimensionalData", "DocStringExtensions", "FileIO", "FreeTypeAbstraction", "KernelAbstractions", "LinearAlgebra", "ModelParameters", "OffsetArrays", "REPL", "Random", "Reexport", "Requires", "Setfield", "StaticArrays", "Test", "UnicodeGraphics"]
git-tree-sha1 = "a99984c15928d6579f670c53077e0f937b378e8a"
...
[[deps.HaltonSequences]]
deps = ["Primes"]
git-tree-sha1 = "9f2dff8d5cdb8b8dda31d7162ecb52627eaba21c"
...
git-tree-sha1 = "fb43404f034d93afeab4657d7eda91e1ed8a35f5"
...
[[deps.MetapopulationDynamics]]
deps = ["CodeTracking", "Distances", "Distributions", "DynamicGrids", "JuliaFormatter", "NeutralLandscapes", "Requires", "SpatialGraphs", "StatsBase", "Term", "UnicodePlots"]
git-tree-sha1 = "e2da55f31e0a03f2fc04109ea5534108163d4eee"
...
deps = ["AbstractNumbers", "ConstructionBase", "ConstructionBaseExtras", "Flatten", "PrettyTables", "Setfield", "Tables"]
git-tree-sha1 = "3fc142295a6d5918214872228428a11451b3a9f7"
...
[[deps.NeutralLandscapes]]
deps = ["DataStructures", "Distributions", "HaltonSequences", "NaNMath", "NearestNeighbors", "Random", "Requires", "Statistics", "StatsBase"]
git-tree-sha1 = "dfea185f31dbab55ffadb6108ec7155b97ac056a"
...
git-tree-sha1 = "5a67996c3f84dfa6a0a1a43f033db8d3aa363a52"
...
[[deps.SpatialGraphs]]
deps = ["Graphs", "Rasters", "SimpleWeightedGraphs", "SparseArrays", "Test"]
git-tree-sha1 = "ba0d5e59acd444c8b547cd4b35b2f4ea68d75e41"
...
[[deps.Term]]
deps = ["CodeTracking", "Dates", "Highlights", "InteractiveUtils", "Logging", "Markdown", "MyterialColors", "OrderedCollections", "Parameters", "ProgressLogging", "Tables", "UUIDs", "Unicode", "UnicodeFun", "WordTokenizers"]
git-tree-sha1 = "af539c0921d43b8cf24422324a4443ff9cbc1601"
...
[[deps.UnicodeGraphics]]
git-tree-sha1 = "36d3beed7494c73474e59fcefaf9ff6e52cfb8c6"
