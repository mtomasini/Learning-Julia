...
# ╔═╡ 8897729a-32e6-11ef-3a31-1571161c3d4b
using Agents

# ╔═╡ c82e5078-2bae-4103-8b34-06946b760bd1
using Statistics: mean

# ╔═╡ 1c7e6539-0a18-4d4c-8e6d-c047919d06cb
numagents = 100

# ╔═╡ e7b1e09b-c0a3-4520-bca6-cd3a56f08977
@agent struct Haploid(NoSpaceAgent)
	trait::Float64
end

# ╔═╡ 3dd5c2ac-35df-4b0b-978f-ec2a9cdf6457
modelstep_neutral!(model::ABM) = sample!(model, nagents(model))

# ╔═╡ 7a85e207-0102-4319-baca-cec40b494052
model = StandardABM(Haploid; model_step! = modelstep_neutral!)

# ╔═╡ b3341c2b-802f-4b77-9b78-29672d9de543
for i in 1:numagents
	add_agent!(model, rand(abmrng(model)))
end

# ╔═╡ 46a0339c-2ead-40bc-8e41-ab0030c6fede
sample!(model, nagents(model))

# ╔═╡ 5f6a775f-cf2d-40a7-8b82-ceb833ce19a7
data, _ = run!(model, 20; adata = [(:trait, mean)])

# ╔═╡ af4b53ea-5f3d-4c52-86d3-dbaff329d515
data
...
manifest_format = "2.0"
project_hash = "3cd67d2aa218887ff8328b9cf8fc6a62b3b18f1f"
