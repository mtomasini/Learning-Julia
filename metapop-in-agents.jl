...
# ╔═╡ a9b5e012-32eb-11ef-3370-cbcbe27c58a0
begin
	using Agents
	using Random
end

# ╔═╡ 0467642b-1702-408a-a0f7-59e958aca5fe
begin
	numagents = 2
	numdemes = 2
	numfeatures = 5
...
# ╔═╡ 970795e8-eb1e-44ed-bd64-1d95e5966eb5
@agent struct Individual(NoSpaceAgent)
	deme::Int64
	rng = MarsenneTwister(123);
	trait = rand!(rng, zeros(numfeatures), Vector(1:numtraits));
end

# ╔═╡ 7f989065-5bc3-4bbb-9971-884c4efd7329
@agent struct Haploid(NoSpaceAgent)
	trait::Float64
end

# ╔═╡ b686f6ac-68ab-4ba7-937d-0bac06ebc48e
modelstep_neutral!(model::ABM) = sample!(model, nagents(model))

# ╔═╡ edc9ce7b-d8c6-46c3-86f8-800da7209987
model = StandardABM(Individual; model_step! = modelstep_neutral!)

# ╔═╡ 2f7aa8ba-7c5f-44ba-99d4-eec7c9447c93
...
manifest_format = "2.0"
project_hash = "f0e0ec5c85a32275512b2ce5e69e53599a05dc52"
...
[[deps.Agents]]
deps = ["CSV", "CommonSolve", "DataFrames", "DataStructures", "Distributed", "Distributions", "Downloads", "Graphs", "JLD2", "LazyArtifacts", "LightOSM", "LinearAlgebra", "MacroTools", "MixedStructTypes", "Pkg", "PrecompileTools", "ProgressMeter", "Random", "Rotations", "Scratch", "StaticArrays", "StatsBase", "StreamSampling"]
git-tree-sha1 = "c2b9b3a291bff09f078e4e25f98241da4cf5f3d1"
...
[[deps.MixedStructTypes]]
deps = ["ExprTools", "MacroTools", "PrecompileTools", "SumTypes", "Suppressor"]
git-tree-sha1 = "2324377d903dc9d8ed4d4a78e922bfef86372531"
...
[[deps.StreamSampling]]
deps = ["Accessors", "DataStructures", "Distributions", "PrecompileTools", "Random", "StatsBase"]
git-tree-sha1 = "2c52cc567601ad3ea46be79e39846a6128e621fe"
...
git-tree-sha1 = "900f20cc431405e75a0d260b78a5f69ceb63c8a5"
